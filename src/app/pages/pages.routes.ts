...
export default [
    ...
    { path: 'counterparties', loadComponent: () => import('./counterparty/counterparty.component').then((c) => c.CounterpartyComponent) },
    { path: 'counterparties/:id', loadComponent: () => import('./counterparty/counterparty-form/counterparty-form.component').then((c) => c.CounterpartyFormComponent) },
